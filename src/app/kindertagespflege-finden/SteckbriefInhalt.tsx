...
// Reiner Steckbrief-Inhalt (Foto, freie Plätze, Galerie, Infos, Kontakt).
// Wird sowohl im Finder-Panel (ProfilePanel, als Modal) als auch auf den
// Banner-Landingpages (/banner1 … als Vollseite) verwendet.
...
export function SteckbriefInhalt({ tagesmutter }: { tagesmutter: TagesmutterDto }) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* 3 — Info-Bereich */}
      <section>
        <h3 className="text-lg font-extrabold mb-3">Alle wichtigen Infos</h3>
